...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void initState() {
    ...
    CleverTapPlugin.createNotificationChannel("divyesh", "divyehs", "Flutter", 5, true);
    super.initState();
  ...
  void onUserLogin() {
    ...
    var profile = {
      'Name': 'divyeshflutter',
      'Identity': '1211',
      'Email': 'divyeshflutter@gmail.com',
      'Phone': '+917506886642',
      'DOB':'27-05-2000',
      'stuff': stuff,
      'MSG-push':true,
  ...
  void recordEvent() {
    ...
    CleverTapPlugin.recordEvent("divyeshpush",eventData);
  }
  void opappinbox(){
    var eventData = {
      "":""
